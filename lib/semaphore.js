 ...
 *   LOCAL_{{CITY_SLUG_UPPER}}_LIMIT_SODA=8 LOCAL_{{CITY_SLUG_UPPER}}_LIMIT_ARCGIS=6 ...
 */
...
function getBucket(key) {
  ...
  if (!b) {
    const envCap = Number(process.env[`LOCAL_{{CITY_SLUG_UPPER}}_LIMIT_${key.toUpperCase()}`]);
